...
from edsrplus import make_edsr_plus_model
...
def train_model(scale, epochs=100, batch_size=16):
    ...
    model = make_edsr_plus_model(num_filters=64, num_of_residual_blocks=32)
    ...
    #model.save('edsrplus_model.h5')
    # Save the model in the .keras format
    model.save('edsrplus_model.keras', save_format='keras')
